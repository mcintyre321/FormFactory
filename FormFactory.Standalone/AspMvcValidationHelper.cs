...
namespace FormFactory
{
    public static class AspMvcValidationHelper
    {
        ...
        public static MvcHtmlString AllValidationMessages(this MyFfHtmlHelper helper, string modelName)
        {
        ...
        public static bool HasErrors(this MyFfHtmlHelper helper, string modelName)
        {
